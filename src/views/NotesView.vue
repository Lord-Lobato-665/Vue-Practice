  ...
  <div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 p-10">
      ...
      <div class="flex gap-4 mb-4">
        <button
          class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 active:scale-90 transition duration-100"
          @click="showNoteModal = true"
        >
          Nueva Nota +
        </button>
        <button
          class="px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500 active:scale-90 transition duration-100"
      ...
      <!-- Lista de Notas -->
      <div class="w-full h-[460px] border border-gray-300 rounded p-4 shadow">
